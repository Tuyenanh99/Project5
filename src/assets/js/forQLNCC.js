...
function Them() {
    ...
    var txtEmail=document.getElementById('emailThem').value;
...
function ClickUpdate(event) {
    ...
    txtSodienthoai.value = td[4].innerText;
...
function Update() {
    ...
    var txtEmail= document.getElementById('emailSua').value;
     td_update[1].innerText = txtMa;
    td_update[2].innerText = txtTen; 
     td_update[3].innerText = txtDiachi;
     td_update[4].innerText = txtSodienthoai;
     td_update[5].innerText = txtEmail; 
    nenden.classList.remove('ndhr');
   form_sua.classList.remove('suahr');
