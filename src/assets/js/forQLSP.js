...
//ham thong ke so luong tat ca san pham
...
//ham thong ke tong gia gia tri san pham
function UpdateTonggia() {
    var tonggia = document.querySelector('.tgsp');
    var all_item = document.querySelector('.listitem');
    var all_tr = all_item.querySelectorAll('tr');
    var sumprice = 0;
    for(var i = 0; i < all_tr.length; i++) {
...
function Them() {
    ...
    var txtGia = document.getElementById('giaThem').value;
    var txtSoluong = document.getElementById('soluongThem').value;
...
function ClickUpdate(event) {
    ...
    td[3].innerText = td[3].innerText.replace(' đ','');
    txtGia.value = td[3].innerText;
...
function Update() {
    ...
    var txtGia = document.getElementById('giaSua').value;
    var txtSoluong = document.getElementById('soluongSua').value;
    td_update[1].innerText = txtMa;
    td_update[2].innerText = txtTen;
    td_update[3].innerText = txtGia + ' đ';
    td_update[4].innerText = txtSoluong;
    nenden.classList.remove('ndhr');
    form_sua.classList.remove('suahr');
